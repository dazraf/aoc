package io.dazraf.aoc.y2020.day12

import io.dazraf.aoc.*
import io.dazraf.aoc.utilities.*
import io.dazraf.aoc.y2020.day12.Op.*

fun main() = Puzzle(2020, 12, "Rain Risk").solve(Puzzle::part1, Puzzle::part2)
...
private fun Puzzle.parseInstructions() = dataSequence.map(Instruction::parse)
